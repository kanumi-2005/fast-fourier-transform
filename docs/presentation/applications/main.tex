...
% ================= MỤC 1 =================
\section{Bản chất toán học của Tích chập}
...
\begin{frame}{Quy trình Tích chập nhanh (Fast Convolution)}
...
% ================= MỤC 3 =================
\section{Xử lý ảnh (Tích chập 2D)}
...
% ================= MỤC 4 =================
\section{Xử lý tín hiệu âm thanh (Tích chập 1D)}
...
\begin{frame}{Tổng kết}
    \begin{center}
        \Large Mọi bài toán xử lý tín hiệu, hình ảnh hay đa thức lớn đều hội tụ về một gốc: \\ \textbf{Phép Tích Chập}.
        \vspace{0.8cm}
        
        \normalsize Và \textbf{FFT (Thuật toán Cooley-Tukey)} chính là cỗ máy biến phép toán khổng lồ này trở nên khả thi trong thực tiễn.
    \end{center}
\end{frame}